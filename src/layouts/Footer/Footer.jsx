                        ...
                        <div className="footer-subscribe-social text-light">
                            ...
                            <div className="footer-social__icons-group">
                                <IconLink 
                                    ...
                                    href="#youtube"                              
                                >
                                    <svg className="footer-social__icon" width="38" height="30" viewBox="0 0 38 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <IconLink 
                                    ...
                                    href="#linkedin"                              
                                >
                                    <svg className="footer-social__icon" width="32" height="30" viewBox="0 0 32 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <IconLink 
                                    ...
                                    href="#google"                              
                                >
                                    <svg className="footer-social__icon" width="47" height="30" viewBox="0 0 47 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <IconLink 
                                    ...
                                    href="#facebook"                              
                                >
                                    <svg className="footer-social__icon" width="14" height="30" viewBox="0 0 14 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <IconLink 
                                    ...
                                    href="#twitter"                              
                                >
                                    <svg className="footer-social__icon" width="37" height="30" viewBox="0 0 37 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className="col col-lg p-0">
                    ...
                    <div className="footer-copyright">
                        ...
                        <IconLink 
                            ...
                            href="#startLogo"
                        > 
                            <svg className="footer-copyright__icon" width="36" height="36" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
